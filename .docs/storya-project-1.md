...
- ✅ BONUS: Full semantic structure with ARIA roles and labels on all pages
- ✅ BONUS: All 15 products from catalog §1.1 implemented in collection.html
- ✅ BONUS: Complete product page structure (360° viewer, accordions, variant pickers)
- ✅ BONUS: Breadcrumb navigation, testimonials, newsletter form
- ✅ BONUS: JSON-LD Organization + Product schemas with proper structured data
...
**Overall Progress: 22/42 items complete (52%)**  
**Phase: Week 1, Days 3-4 Complete** — HTML structure done, ready for styling

### Infrastructure & Setup ✅ 8/8
...
### HTML & Semantics ✅ 11/11
- [x] W3C HTML validation passes on all pages (HTML hợp lệ theo W3C)
- [x] Semantic HTML5 structure for all pages
- [x] Meta tags and Open Graph on all pages
- [x] JSON-LD schema on product page (Product schema)
- [x] JSON-LD schema on home page (Organization schema)
- [x] Skip-to-content links on all pages
- [x] ARIA roles and labels throughout
- [x] Accessible forms with proper labels
- [x] Semantic landmarks (header, nav, main, footer)
- [x] All 15 products from catalog implemented
- [x] Breadcrumb navigation on product page

### Performance & Quality 🚧 0/4
...
### Accessibility ⚠️ Partial 5/8
- [x] Skip-to-content link functional
- [x] All images have `alt` attributes
- [x] ARIA labels on interactive elements
- [x] Form controls with proper labels
- [x] Semantic HTML structure
- [ ] All interactions usable by keyboard only (incl. 360° viewer) (Mọi tương tác dùng được bằng bàn phím) — needs JS implementation
- [ ] **`prefers-reduced-motion` disables all 3D/parallax/marquee** (Tắt hết chuyển động khi được yêu cầu) — needs CSS implementation
- [ ] Focus states visible and accessible — needs CSS styling

### Code Quality ⚠️ Partial 2/3
- [x] Zero jQuery / zero external JS libraries in the core build (Không jQuery / không thư viện JS ngoài ở phần lõi)
- [x] Conventional commits throughout history (Commit theo chuẩn) — 7 commits so far
- [ ] Every class name follows BEM; documented in README (Mọi class theo BEM) — pending CSS implementation
